...
$stmt = $this->conn->prepare("INSERT INTO tasks (title, description, department, status, created_at, deadline)
...
$deadline = htmlspecialchars($data['deadline']); // Get the deadline
 ...
 $stmt = $this->conn->prepare("UPDATE tasks SET title = :title, description = :description, department = :department, deadline = :deadline WHERE id = :id");
